...
Renderer::Renderer(Window& parent) :OGLRenderer(parent) {
	...
	for (int i = 0; i < 5; i++) {
		...
		s->SetTransform(Matrix4::Translation(Vector3(0, 100.0f, -200.0f + i * 100)));
...
void Renderer::SortNodeLists() {
	std::sort(transparentNodeList.rbegin(), transparentNodeList.rend(), SceneNode::CompareByCameraDistance); //note the r before begin and end!
